    ...
    <>
      <div className="bg-black text-white py-[40px] ">
        <div className="container">
          <h2 className="text-xl text-center sm:text-3xl md:text-2xl text-white/70">Trusted by the world's most innovative teams.</h2>
          {/* slight vanishing blurry effect - fadein and fadeout effect*/}
           <div className="overflow-hidden mt-9 sm:mt-10 md:mt-11 lg:mt-12 before:content-['']  after:content-[''] before:absolute
