...
export const Hero = () => {
  ...
  const cursorXTransform = useTransform(cursorX, [0, windowWidth], [-50, 50]);
  const cursorYTransform = useTransform(cursorY, [0, windowHeight], [-30, 30]);
  const messageXTransform = useTransform(messageX, [0, windowWidth], [-40, 40]);
  const messageYTransform = useTransform(messageY, [0, windowHeight], [-20, 20]);
  ...
  useEffect(() => {
    ...
    messageX.set(mouseX);
    messageY.set(mouseY);
  }, [mouseX, mouseY, cursorX, cursorY, messageX, messageY]);
...
//     messageX.set(mouseX);
//     messageY.set(mouseY);
//   }, [mouseX, mouseY,cursorX,cursorY,messageX,messageY]); // Include mouseX and mouseY as dependencies
